...
public /*@ nullable_by_default */ class Path_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {Path_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(Path_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(Path.class),
   ...
   *
   * @param the_test_object The Path to call the test method on.
  ...
  () {
    try {
      ...
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_Path__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  /**
   * A test for method compare.
   *
   * @param the_test_object The Path to call the test method on.
   * @param lhs The int to be passed.
   * @param rhs The int to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_compare__int_lhs__int_rhs__0")
  public void test_static_compare__int_lhs__int_rhs__0
  ( final int lhs, final int rhs) {
    try {
      Path.compare(lhs, rhs);
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_static_compare__int_lhs__int_rhs__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  public static IteratorWrapper<Object[]> p_main__String1DArray_args__10() {
    ...
    (new ParameterArrayIterator
         (Path_main__String1DArray_args__10__args.class));
  }



  /**
   * Data provider for method int compare(int, int).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_compare__int_lhs__int_rhs__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_compare__int_lhs__int_rhs__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (Path_compare__int_lhs__int_rhs__0__lhs.class,
          Path_compare__int_lhs__int_rhs__0__rhs.class));
  }
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(Path_InstanceStrategy.class));
  }
}
 ...
 * instances of Path for testing, using
 * parameters from constructor tests.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2019-05-21 01:17 +0800
 */
public /*@ nullable_by_default */ class Path_InstanceStrategy extends ObjectStrategy {
  /**
   * @return local-scope instances of Path.
   */
  public RepeatedAccessIterator<?> localValues() {
    return new ObjectArrayIterator<Object>
    (new Object[]
     { /* add Path values or generators here */ });
  }

  /**
   * @return default instances of Path, generated
   *  using constructor test parameters.
   */ 
  public RepeatedAccessIterator<Path> defaultValues() {
    final List<RepeatedAccessIterator<Path>> iters = 
      new LinkedList<RepeatedAccessIterator<Path>>();

    // an instantiation iterator for the default constructor
    // (if there isn't one, it will fail silently)
    iters.add(new InstantiationIterator<Path>
      (Path.class, 
       new Class<?>[0], 
       new ObjectArrayIterator<Object[]>(new Object[][]{{}})));

    return new NonNullMultiIterator<Path>(iters);
  }
